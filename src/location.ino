...
char ssid[] ="Its mine";    // your network SSID (name) 
char pass[] = "Nammi9823";   // your network password

// Google API key
String geolocationKey = "AIzaSyA2d5BK8zQaJY7pDZ7FsU0dT4y3s1pl864";
String geocodingKey   = "AIzaSyA2d5BK8zQaJY7pDZ7FsU0dT4y3s1pl864";

int MCC = 405;  // Country Code
int MNC = 53;    // Network Code
